...
#Region " Private "
    ...
    Private Shared Sub displayMsg(ByVal msg As String)
        ...
        Dim ostream As System.IO.StreamWriter
        If Not System.IO.File.Exists("Questionnaire.log") Then
            System.IO.File.Open("Questionnaire.log", IO.FileMode.CreateNew)
        End If
        ostream = System.IO.File.AppendText("Questionnaire.log")
